 ...
 * ngày 17/08/2026:
 *
 *   zernioPlatform — định danh dùng cho GET /connect/{platform}.
...
export const socialChannels: PlatformChannel[] = [
  { id: 'fb', name: 'Facebook', zernioPlatform: "facebook", canPost: true, canDm: true, canComment: true, icon: 'facebook', connectionType: 'oauth_with_selection', selectionLabel: 'Trang', 
  ...
  { id: 'ig', name: 'Instagram', zernioPlatform: "instagram", canPost: true, canDm: true, canComment: true, icon: 'photo_camera', connectionType: 'oauth_simple',
  ...
  { id: 'tt', name: 'TikTok', zernioPlatform: "tiktok", canPost: true, canDm: false, canComment: false, capabilityNote: "TikTok không mở API hộp thư: AI không đọc được tin nhắn hay bình luận. Chỉ dùng để đăng bài.", icon: 'music_note', connectionType: 'oauth_simple', publishOnly: true,
  ...
  { id: 'yt', name: 'YouTube', zernioPlatform: "youtube", canPost: true, canDm: false, canComment: true, capabilityNote: "Không có tin nhắn riêng, AI chỉ trả lời được bình luận.", icon: 'play_circle', connectionType: 'oauth_simple',
  ...
  { id: 'th', name: 'Threads', zernioPlatform: "threads", canPost: true, canDm: false, canComment: true, capabilityNote: "Không có tin nhắn riêng, AI chỉ trả lời được bình luận.", icon: 'alternate_email', connectionType: 'oauth_simple',
  ...
  { id: 'x', name: 'X (Twitter)', zernioPlatform: "twitter", canPost: true, canDm: true, canComment: true, icon: 'close', connectionType: 'oauth_simple',
  ...
  { id: 'li', name: 'LinkedIn', zernioPlatform: "linkedin", canPost: true, canDm: false, canComment: true, capabilityNote: "Không có tin nhắn riêng qua API.", icon: 'work', connectionType: 'oauth_with_selection', selectionLabel: 'Tổ chức hoặc Trang cá nhân',
  ...
  { id: 'pi', name: 'Pinterest', zernioPlatform: "pinterest", canPost: true, canDm: false, canComment: false, capabilityNote: "Chỉ đăng bài, không có hộp thư.", icon: 'push_pin', connectionType: 'oauth_with_selection', selectionLabel: 'Bảng', publishOnly: true,
  ...
  { id: 're', name: 'Reddit', zernioPlatform: "reddit", canPost: true, canDm: true, canComment: true, icon: 'forum', connectionType: 'oauth_with_selection', selectionLabel: 'Subreddit',
  ...
  { id: 'sc', name: 'Snapchat', zernioPlatform: null, canPost: true, canDm: false, canComment: false, capabilityNote: "Snapchat đang trong giai đoạn beta phía Zernio, chưa kết nối được.", icon: 'filter_vintage', connectionType: 'oauth_simple', publishOnly: true,
  ...
  { id: 'wa', name: 'WhatsApp', zernioPlatform: "whatsapp", canPost: true, canDm: true, canComment: false, capabilityNote: "Không có bình luận. Tin nhắn ngoài 24 giờ phải dùng mẫu đã duyệt.", icon: 'chat', connectionType: 'oauth_simple',
  ...
  { id: 'di', name: 'Discord', zernioPlatform: "discord", canPost: true, canDm: false, canComment: false, capabilityNote: "Chỉ đăng bài.", icon: 'sports_esports', connectionType: 'oauth_simple',
  ...
  { id: 'sl', name: 'Slack', zernioPlatform: "slack", canPost: true, canDm: true, canComment: false, capabilityNote: "Nhắn tin nội bộ, không phải kênh bán hàng cho khách.", icon: 'tag', connectionType: 'oauth_simple',
  ...
  { id: 'gb', name: 'Google Business', zernioPlatform: "googlebusiness", canPost: true, canDm: false, canComment: false, capabilityNote: "Dùng cho hồ sơ doanh nghiệp và đánh giá.", icon: 'storefront', connectionType: 'oauth_with_selection', selectionLabel: 'Địa điểm',
...
export const adChannels: PlatformChannel[] = [
  { id: 'fb_ads', name: 'Meta Ads', zernioPlatform: null, canPost: false, canDm: false, canComment: false, capabilityNote: "Tự động có khi bạn kết nối Facebook. Không kết nối riêng.", icon: 'campaign', connectionType: 'oauth_simple',
  ...
  { id: 'gg_ads', name: 'Google Ads', zernioPlatform: null, canPost: false, canDm: false, canComment: false, capabilityNote: "Chưa hỗ trợ kết nối qua hệ thống.", icon: 'ads_click', connectionType: 'oauth_simple',
  ...
  { id: 'tt_ads', name: 'TikTok Ads', zernioPlatform: null, canPost: false, canDm: false, canComment: false, capabilityNote: "Chưa hỗ trợ kết nối qua hệ thống.", icon: 'music_note', connectionType: 'oauth_simple',
  ...
  { id: 'li_ads', name: 'LinkedIn Ads', zernioPlatform: null, canPost: false, canDm: false, canComment: false, capabilityNote: "Chưa hỗ trợ kết nối qua hệ thống.", icon: 'work', connectionType: 'oauth_simple',
  ...
  { id: 'pi_ads', name: 'Pinterest Ads', zernioPlatform: null, canPost: false, canDm: false, canComment: false, capabilityNote: "Chưa hỗ trợ kết nối qua hệ thống.", icon: 'push_pin', connectionType: 'oauth_simple',
  ...
  { id: 'x_ads', name: 'X Ads', zernioPlatform: null, canPost: false, canDm: false, canComment: false, capabilityNote: "Chưa hỗ trợ kết nối qua hệ thống.", icon: 'close', connectionType: 'oauth_simple',
  ...
  { id: 'ai_ads', name: 'OpenAI Ads', zernioPlatform: null, canPost: false, canDm: false, canComment: false, capabilityNote: "Chưa hỗ trợ kết nối qua hệ thống.", icon: 'smart_toy', connectionType: 'oauth_simple',
...
export const communicationChannels: PlatformChannel[] = [
  { id: 'sms', name: 'SMS (Twilio)', zernioPlatform: null, canPost: false, canDm: true, canComment: false, capabilityNote: "Cần tài khoản Twilio riêng, chưa nối vào hệ thống.", icon: 'sms', connectionType: 'manual_credentials',
  ...
  { id: 'voice', name: 'Voice (Twilio)', zernioPlatform: null, canPost: false, canDm: false, canComment: false, capabilityNote: "Cần tài khoản Twilio riêng, chưa nối vào hệ thống.", icon: 'call', connectionType: 'manual_credentials',
...
export function channelByZernioPlatform(platform: string): PlatformChannel | undefined {
  return allChannels.find((channel) => channel.zernioPlatform === platform);
}
